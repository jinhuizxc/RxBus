...
import com.jh.rxbus.baserx.GsonDConverterFactory;
...
public class Api {
    ...
    //连接时长，单位：毫秒
    public static final int CONNECT_TIME_OUT = 30000;   // 7676
    /**
     * 设缓存有效期为两天
     */
...
/*
   1. noCache 不使用缓存，全部走网络
    ...
    //构造方法私有
    private Api(Context context, final String sign) {
        //开启Log
...
//                        .addHeader("Connection", "close")
     ...
     */
    public static ApiService getDefault(int hostType, Context context, String sign) {
        LogUtils.loge("初始化ApiService");
        Api retrofitManager = sRetrofitManager.get(hostType);
        if (retrofitManager == null) {
            sContext = context;
            // 构造方法私有化，网络的封装在这里
            retrofitManager = new Api(context, sign);
